...
const securityHeaders = [
  ...
  //   frame-ancestors 'none' mirrors X-Frame-Options for CSP-aware browsers
  {
    ...
    value: [
      ...
      "connect-src 'self' http://localhost:8080 ws://localhost:4000 http://localhost:4000 ws://127.0.0.1:4000 http://127.0.0.1:4000 https://algobuddy-backend-7iwv.onrender.com https://*.supabase.co https://*.googlesyndication.com https://*.google.com https://*.google-analytics.com https://*.googletagmanager.com https://*.google.com https://*.tagassistant.google.com https://*.cloudflare.com",
